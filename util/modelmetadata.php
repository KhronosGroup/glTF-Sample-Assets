	...
	private $metaJson = '
{
	...
	public function writeReadme($tagListings = null)
	{
		...
		$readme[] = '<!-- This file is auto-generated by ' . AppName . '. Do not edit by hand. -->';
		$readme[] = '## Tags';
		$readme[] = $tagString;
	...
	private function _generateCredits()
	{
		...
		for ($ii = 0; $ii < count($this->metadata['legal']); $ii++) {
			if (!(isset($this->metadata['legal'][$ii]['artist']) && isset($this->metadata['legal'][$ii]['what']))) {
				...
				$credit[] = sprintf('&copy; %04d, %s. [%s](%s)', $this->metadata['legal'][$ii]['year'], $this->metadata['legal'][$ii]['owner'], $this->metadata['legal'][$ii]['text'], str_replace(' ', '%20', $this->metadata['legal'][$ii]['licenseUrl']));
